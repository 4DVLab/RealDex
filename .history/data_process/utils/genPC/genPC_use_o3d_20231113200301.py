...
def get_target_folders(root_folder:Path,folder_prefix:Path = "",folder_postfixs: List[Path] = []) ->None:
    temp_path = root_folder / folder_prefix
    result_path_list = [temp_path / post_path for post_path in folder_postfixs]
