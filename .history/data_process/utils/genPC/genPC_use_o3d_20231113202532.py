...
def gen_pcd_with_depth_and_rgb(rgb_param,depth_param,rgb_img_folder,depth_img_folder,depth_img,rgb_img):
    rgb_img_path = rgb_img_folder / Path(str(rgb_index) + ".png")
    depth_img_path = depth_img_foder / Path(str(img_index) + ".png")
