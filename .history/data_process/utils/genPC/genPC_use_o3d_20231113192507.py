...
def gen_aligned_pc(bag_data_path:str):
    ...
    for cam_index in np.arange(cam_num):
        ...
        #以depth为主来生成点云
        for img_index in np.arange(rgb_stamp.shape[0]):
        ...
        shutil.copy2(rgb_img_folder / Path("info.txt"),cam_folder / Path("points2"))#将depth_stamp当作是points_stramp,所有的stamp都是以主相机为准
