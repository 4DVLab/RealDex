...
class gen_merge_pcd_ply:
    ...
    def gen_cams_time_stamp(self,):
        ...
        for cam_index in np.arange(1,4):
            for cam_time_stamp in all_cams_time_stamp_list[cam_index]:
                index = common.find_time_closet(all_cams_time_stamp_list[0],cam_time_stamp)
                all_cams_align_to_cam0_rgb_time_stamps[cam_index].append(all_cams_time_stamp_list[0][index])
