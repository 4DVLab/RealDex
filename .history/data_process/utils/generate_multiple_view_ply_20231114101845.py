...
class gen_merge_pcd_ply:
    def __init__(self, bag_folder, four_cam_intrisics_extrisics_save_folder):
        """
        ...
        for time_index in self.all_cams_time_stamp_index[0]:
            ...
            for cam_index in np.arange(4):
                pcd = self.gen_pcd_with_depth_and_rgb_paths(
                    self.all_cams_time_stamp_index[cam_index][time_index], time_index)
...
if __name__ == "__main__":
    bag_folder = Path("/media/tony/T7/camera_data/banana")
    four_cam_intrisics_extrisics_save_folder = Path(
        "/media/tony/T7/camera_data/data")
