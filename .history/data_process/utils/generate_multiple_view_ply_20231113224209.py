...
class gen_multi_view_ply:
    def __init__(self,root_path,four_cam_intrisics_extrisics_save_folder) -> List[str,Dict[str,int]]:
        ...
        """
        intrisics,extrics = self.get_four_cam_intrisics_extrisics(four_cam_intrisics_extrisics_save_folder)
    
    def load_one_camera_intrisics(self,cam_intrisics_extrisics_folder:Path,cam_num:Path)->Dict[str,int]:
        cam_intrisics_path = cam_intrisics_extrisics_folder / cam_num
    def load_internal_camera_extrisics(self,)
