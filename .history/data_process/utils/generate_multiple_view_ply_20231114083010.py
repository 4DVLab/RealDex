...
class gen_merge_pcd_ply:
    ...
    def gen_cams_time_stamp(self):
        ...
        all_cams_align_to_cam0_rgb_time_stamps = [all_cams_time_stamp_list[0].shape[0],[],[],[]]
    ...
    def merge_pcd_and_filter(self):
        ...
        for time_stamp in self.all_cams_time_stamp_list[0]:
            for cam_index in np.arange(4):
                pcd = self.gen_pcd_with_depth_and_rgb_paths(self.all_cams_time_stamp_list[cam_index],cam_index)
