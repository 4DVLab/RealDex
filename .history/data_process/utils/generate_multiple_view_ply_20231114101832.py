...
class gen_merge_pcd_ply:
    ...
    def load_internal_camera_extrisics(self, cam_extrisics_folder: Path, cam_num: Path):
        ...
        with open(cam_extrisics_path, "r") as json_reader:
            ...
            rotation = np.array(list(camera_data["value0"]["rotation"].values())).flatten()[[3, 0, 1, 2]]
...
if __name__ == "__main__":
    ...
    gen_merge_pcd = gen_merge_pcd_ply(bag_folder,four_cam_intrisics_extrisics_save_folder)
