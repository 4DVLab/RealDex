...
def get_new_gt_transform_with_icp(bag_path, new_begin_tracking_index, cam_index, mesh_model_name):
    ...
    mesh_model_process_icp = mesh_model_transform_to_world_frame_with_tracking_result.transform(icp_transform)

    mesh_model_icp_in_cam0_frame = mesh_model_process_icp.transform
