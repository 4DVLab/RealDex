...
def transform_obj2result_pose(bag_folder_path, model_name, transform_mesh_interval = [0,99999], cam2world_transform=None,cam_in):
    ...
    pose_path = Path(bag_folder_path) / Path(f"tracking_result/{bag_name}_cam_index_{}_tracking_result.txt")
