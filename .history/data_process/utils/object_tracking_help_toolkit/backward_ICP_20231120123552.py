...
def load_cam0rgb_to_world_transform(bag_path):
    ...
    cam0rgb_to_world_tranform = np.array(cam0rgb_to_world_tranform).reshape(())


def get_new_gt_transform_with_icp(bag_path):
...
def backward_nsteps(bag_path,n_steps_backward):
    ...
    new_gt_tranform = get_new_gt_transform_with_icp(bag_path)
