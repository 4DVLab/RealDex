...
def save_camera_parameters(vis):
    ...
    o3d.io.write_pinhole_camera_parameters(
        "/media/tony/新加卷/test_data/test/test_1/cam0/rgb/image_raw/0.png", parameters)


bag_path = "/media/tony/新加卷/test_data/test/test_1/merged_pcd_filter/merge_pcd_0.ply"
