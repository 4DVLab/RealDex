...
def transform_obj2result_pose(bag_folder_path, model_name, transform_mesh_interval, cam2world_transform=None):
...
if __name__ == "__main__":
    ...
    transform_obj2result_pose(bag_folder_path, model_name,
                              cam0_rgb_camera_link2world, transform_mesh_interval)
