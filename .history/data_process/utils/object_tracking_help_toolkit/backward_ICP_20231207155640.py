...
def backward_nsteps(bag_path, n_steps_backward, cam_index, mesh_model_name):
    ...
    gen_pcd_for_annotate(root_path=Path(bag_path),four_cam_intrisics_extrisics_save_folder=four_cam_intrisics_extrisics_save_folder,constrain_bound=[new_begin_tracking_index,new_begin_tracking_index])
