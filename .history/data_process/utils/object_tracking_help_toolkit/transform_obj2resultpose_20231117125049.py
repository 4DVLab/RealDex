...
def transform_obj2result_pose(bag_folder_path, model_name, transform_mesh_interval = [0,99999], cam2world_transform=None):
    ...
    pose_path = Path(bag_folder_path) / Path(f"tracking_result/{bag_name}_tracking_result.txt")
    ...
    #         future.result()
    transform_mesh_interval[1]
    transform_mesh_interval[1] = min(transform_mesh_interval[1] + 1,tranform_matrixs.shape[0])
