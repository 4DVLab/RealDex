...
def get_new_gt_transform_with_icp(bag_path, new_begin_tracking_index, cam_index, mesh_model_name):
    ...
    mesh_model_icp_in_cam0_frame_transform = mesh_model_transform_to_world_frame_with_tracking_result.transform(
                        np.linalg.inv(cam0rgb_to_world_transform)@icp_transform)
