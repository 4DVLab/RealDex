...
def write_transform_to_gt_file(bag_path,transform,gt_index):
    ...
    with open(file_path,"w") as tansform_writer:
        np.savetxt(transform_writer,transf)
...
def backward_nsteps(bag_path, n_steps_backward, cam_index, mesh_model_name):
    ...
    get_new_gt_transform_with_icp(bag_path,new_begin_tracking_index,cam_index,mesh_model_name)
