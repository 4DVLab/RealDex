...
def show_obj_env_pcd(bag_folder_path, viz_camera_info_path):
    ...
    obj_folder = Path(bag_folder_path) / Path("object_pose_in_every_frame_with_icp")
    image_save_folder = Path(bag_folder_path) / Path("object_pose_in_every_frame_with_icp_image")
