...
object_folder = folder / Path(f"capture_image")

save_folder = folder / Path("objecct_merge_with_rgb")
os.makedirs(save_folder,exist_ok=True)
for index in np.arange(0,223):
    ...
    hand_arm_img = cv2.imread(str(hand_arm_imobject_img_pathg_path), -1)
