...
if __name__ == "__main__":
    ...
    mesh = o3d.io.read_triangle_mesh("/media/tony/新加卷/test_data/test/test_1/models/yogurt.obj")
    mesh = mesh.transform(transform_matrix)
    o3d.io.write_triangle_mesh("/media/tony/新加卷/test_data/test/test_1/models/yogurt_transformed.obj",mesh)
