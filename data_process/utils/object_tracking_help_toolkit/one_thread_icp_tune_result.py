...
def icp_mesh_pcd(mesh_model, pcd):
    ...
    if icp_mode == 1:
        ...
        print("use mesh_model to pcd mode")
        source_pcd = mesh_model.sample_points_uniformly(number_of_points=10000)
        icp_result = o3d.pipelines.registration.registration_icp(
            source_pcd, pcd, max_correspondence_distance=0.05,
            estimation_method=o3d.pipelines.registration.TransformationEstimationPointToPoint(),
            criteria=o3d.pipelines.registration.ICPConvergenceCriteria(relative_fitness= 1e-06,relative_rmse= 1e-06,max_iteration=10000))
