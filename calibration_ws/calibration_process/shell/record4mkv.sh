...
k4arecorder -d WFOV_UNBINNED  --device 1 --external-sync subordinate --imu OFF -c 1080p -r 5 -l 2 output-4.mkv&
...
k4arecorder -d WFOV_UNBINNED  --device 3 --external-sync master --imu OFF -c 1080p -r 5 -l 2 output-1.mkv
